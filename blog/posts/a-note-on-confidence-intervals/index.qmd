...
---
![Photo by Joel Henry on Unsplash](joel-henry-fU-oPNhdsO8-unsplash.jpg){.post-hero}
...
First, *X* denotes the *confidence level* which is one minus the Type 1 error rate, $\alpha$\$\\alpha\$. Next, the *range of estimates* refer to values on either side of the point estimate and are computed using the confidence interval equation for the sample in hand. Mathematically, the confidence interval is computed as:
